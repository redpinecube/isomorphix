...
Isomorphix is a project created for Princeton University's VNC Matching Challenge, which aims to create an optimal mapping alignment score between the connectomes of male and female drosophila. 
## File Structure 
